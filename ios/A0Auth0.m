...
RCT_EXPORT_METHOD(showUrl:(NSString *)urlString closeOnLoad:(BOOL)closeOnLoad useAuthSession:(BOOL)useAuthSession callback:(RCTResponseSenderBlock)callback) {
    if (@available(iOS 11.0, *) && useAuthSession) {
